...
<table class="table table-hover w3-white">
  ...
  <tbody id="filtro">
  <input type="text" class="form-control mb-3" id="myInput" placeholder="Filter for date, time,...">       
     ...
     <tr>      
      ...
      <td><a href="{{ URL::action('ReservationController@edit', $e)}}"class="btn btn-outline-primary btn-sm font-weight-bold">Modify</a></td>
    </tr> 
    @endif
   @endforeach
  </tbody>
...
<button class="btn w3-purple">
    <a href="{{ URL::action('ReservationController@create') }}" >  
     Add reservation
  </button>
@endif
</div>
