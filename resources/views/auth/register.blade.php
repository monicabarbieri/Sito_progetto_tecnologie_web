...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header w3-purple row justify-content-center"><?php echo e(__('Sign up')); ?></div>
...
unset($__errorArgs, $__bag); ?><?php echo e(old('gender')); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input type="tel" id="telephone_number" name="telephone_number" placeholder="333 1234567" pattern="[0-9]{10}" required><br><br>

<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
unset($__errorArgs, $__bag); ?><?php echo e(old('telephone_number')); ?>
...
unset($__errorArgs, $__bag); ?>" name="date_of_birth" value="<?php echo e(old('date_of_birth')); ?>" required autocomplete="date_of_birth" autofocus>
...
<div class="col-md-6">
    <input id="ssn" type="string" class="form-control <?php $__errorArgs = ['ssn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="ssn" required autocomplete="new-ssn">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-5">
                                <button type="submit" class="btn btn w3-purple">
